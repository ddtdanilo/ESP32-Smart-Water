void append_page_header() {
  ...
  webpage += F("<head>");
  webpage += F("<title>Wiot File Manager 0.1</title>"); // NOTE: 1em = 16px
  ...
  webpage += F("</style></head><body><h1>Wiot File Manager 0.1 "); webpage += "</h1>";
}
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
void append_page_footer(){ // Saves repeating many lines of code for HTML page footers
  webpage += F("<ul>");
  webpage += F("<li><a href='/'>Inicio</a></li>"); // Lower Menu bar command entries
  webpage += F("<li><a href='/download'>Buscar archivo</a></li>"); 
  webpage += F("</ul>");
  webpage += "<footer>&copy;"+String("Wiot 2019")+"</footer>";
  webpage += F("</body></html>");
}
