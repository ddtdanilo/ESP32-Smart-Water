...
// -----------------------------------------------
#define   servername "homeiot"     // Set your server's logical name here e.g. if myserver then address is http://myserver.local/
...
const char ssid_1[]     = "ARAGUANEY";
const char password_1[] = "2816SSSpelusa";
